...
document
  ...
  .addEventListener("click", function (event) {
    event.preventDefault(); // Prevent default anchor behavior
    window.scrollTo({ top: 840, behavior: "smooth" }); // Smooth scroll to top
  });
// Scroll to the top of the page when clicking "Description"
document
  .getElementById("description-link3")
  .addEventListener("click", function (event) {
    event.preventDefault(); // Prevent default anchor behavior
    window.scrollTo({ top: 680, behavior: "smooth" }); // Smooth scroll to top
  });
...
document
  ...
  .addEventListener("click", function (event) {
    event.preventDefault(); // Prevent default anchor behavior
    window.scrollTo({ top: 2450, behavior: "smooth" }); // Smooth scroll to top
  });
// Scroll to the top of the page when clicking "Checkout"
document
  .getElementById("checkout-link3")
  .addEventListener("click", function (event) {
    event.preventDefault(); // Prevent default anchor behavior
    window.scrollTo({ top: 2200, behavior: "smooth" }); // Smooth scroll to top
  });
// Scroll to the top of the page when clicking "Checkout"
document
